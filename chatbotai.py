...
def bot_response(user_input):
    ...
    index = index[1:]
    response_flag = 0
    # bring back top 2 similar sentences
    j = 0
...
print('Doctor bot here!!: I am doctor bot here and i will answer your queries!! Type bye if you are not interested')
while(True):
    user_input=input()
    if user_input.lower() in exit_list:
        print('Doctor bot: Had good time with you!!')
        break
    else:
